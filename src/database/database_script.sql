...
-- CHANGE: Added skills table for a specific set of skills
CREATE TABLE IF NOT EXISTS skills (
    id UUID PRIMARY KEY,
    skill_name VARCHAR(100) NOT NULL UNIQUE
);

-- CHANGE: Added user_skills table for M-N relationship between users and skills
...
-- CHANGE: Added universities table for a specific set of universities
CREATE TABLE IF NOT EXISTS universities (
    id UUID PRIMARY KEY,
    university_name VARCHAR(255) NOT NULL UNIQUE
);

-- CHANGE: Added user_education table for M-N relationship between users and universities
...
-- CHANGE: Added indexes for new tables (skills, universities, user_skills, user_education)
